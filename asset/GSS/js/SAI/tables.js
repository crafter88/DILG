var initTables = function(scope, compile){
	...
	var pending_table = $('#pending-table').DataTable({
		ajax: base_url+"/gss/head/sai/pending_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var rejected_table = $('#rejected-table').DataTable({
		ajax: base_url+"/gss/head/sai/rejected_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var confirmed_table = $('#confirmed-table').DataTable({
		ajax: base_url+"/gss/head/sai/confirmed_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var draft_table = $('#draft-table').DataTable({
		ajax: base_url+"/gss/head/sai/draft_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var cancelled_table = $('#cancelled-table').DataTable({
		ajax: base_url+"/gss/head/sai/cancelled_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	$('#pending-table').on('click', '.cancel-sai', function(){
		...
		$.post(base_url+"/gss/head/sai/post_cancel_sai", {id: data.id}).done(function(){
			location.reload();
		});
	});
