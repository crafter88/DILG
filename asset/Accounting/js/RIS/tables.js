var initTables = function(scope, compile){
	...
	var pending_table = $('#pending-table').DataTable({
		ajax: base_url+"/accounting/head/ris/pending_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var rejected_table = $('#rejected-table').DataTable({
		ajax: base_url+"/accounting/head/ris/rejected_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var confirmed_table = $('#confirmed-table').DataTable({
		ajax: base_url+"/accounting/head/ris/confirmed_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var draft_table = $('#draft-table').DataTable({
		ajax: base_url+"/accounting/head/ris/draft_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	var cancelled_table = $('#cancelled-table').DataTable({
		ajax: base_url+"/accounting/head/ris/cancelled_sai",
		columns: [
					{'data': 'sai_no'},
					{'data': 'status'},
					{'data': 'date_created'},
	...
	$('#pending-table').on('click', '.cancel-sai', function(){
		...
		$.post(base_url+"/accounting/head/ris/post_cancel_sai", {id: data.id}).done(function(){
			location.reload();
		});
	});
