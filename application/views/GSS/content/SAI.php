...
<section class="content">
	                ...
	                <div class="box-body">
				            <div class="nav-tabs-custom">
				                <ul class="nav nav-tabs" style="margin-bottom: 20px;">
				                 	...
				                 	<li style="float: right;"><button id='create-sai-btn' type='button' class='btn btn-default'>Create SAI<i class='fa fa-file'></i></button></li>
				                </ul>
	...
	<form id='save_sai' action="<?php echo base_url(); ?>gss/head/sai/save_sai" method='post'>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 style="margin: 0;"><input class='form-control' type='text' name='sai_no' value="SAI No. {{ last_sai_id }}" style='background-color: transparent; border: none; width: 50%; font-size: 18px; font-weight: bold;' readonly></h4>
				...
				<div class='modal-footer'>
					<button type='submit' class='btn btn-default'>Create SAI</button>
				</div>
			</div>
		</div>
	</div>
