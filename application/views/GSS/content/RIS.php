...
<section class="content">
			...
			<div class="col-md-12">
              	<div class="box box-default">
	                <div class="box-header with-border">
	                  	<h3 class="box-title">Requisition Issue Slip (Admin)</h3>
						...
						<div class="box-body">
				            <div class="nav-tabs-custom">
				                <ul class="nav nav-tabs" style="margin-bottom: 20px;">
				                	<li class="active"><a href="#all-all" data-toggle="tab">All</a></li>
				                	<li><a href="#all-completed" data-toggle="tab">Completed</a></li>
				                	<li><a href="#all-incomplete" data-toggle="tab">Incomplete</a></li>
				                  	<li><a href="#all-confirmed" data-toggle="tab">Confirmed</a></li>
				                  	<li><a href="#all-pending" data-toggle="tab">Pending</a></li>
	                  			...
	                  			<div class="tab-content">
	                  				...
	                  				<div class="tab-pane" id="all-completed">
				                    	<table id='all-completed-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Date Created</th>
				                 	...
				                 	<div class="tab-pane" id="all-incomplete">
				                    	<table id='all-incomplete-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Date Created</th>
				                  	...
				                  	<div class="tab-pane" id="all-pending">
					                  	<table id='all-pending-table' class='table table-bordered table-hover table-striped' width="100%">
					                  		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Date Created</th>
				                  	...
				                  	<div class="tab-pane" id="all-confirmed">
				                    	<table id='all-confirmed-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Date Created</th>
				                  	...
				                  	<div class="tab-pane" id="all-rejected">
				                    	<table id='all-rejected-table' class='table table-bordered table-hover table-striped' width="100%">
				                    		<thead>
						                  		<th>RIS No</th>
						                  		<th>Status</th>
						                  		<th>Date Created</th>
	...
	<form id='save_ris' action="<?php echo base_url(); ?>gss/head/ris/save_ris" method='post'>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 style="margin: 0;"><input class='form-control' type='text' name='sai_no' value="Create RIS" style='background-color: transparent; border: none; width: 50%; font-size: 18px; font-weight: bold;' readonly></h4>
						...
						<div class='row'>
							<div class="col-md-6">
								<div class="box box-primary">
									<div class="box-body">
										<h4 style='background-color: transparent; border: none; width: 50%; font-size: 18px; font-weight: bold;'> PPMP </style> </h4>
	...
	<div id='dispense-modal' class="modal" role='dialog' tabindex='-1'>
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<button type='button' class='close close-create-sai-modal'><span aria-hidden='true'>&times; </span></button>
					<h4 style="margin: 0;"><input class='form-control' type='text' name='sai_no' value="Dispense Items" style='background-color: transparent; border: none; width: 50%; font-size: 18px; font-weight: bold;' readonly></h4>
					<input id='save_sai_status' type='hidden' name='sai_status' value="pending">
					<input type='hidden' name='sai_date_created' value="{{ date_today }}">
				</div>
				<div class="modal-body" style="max-height: 480px; overflow-y: auto;">
					<div class='row'>
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-body">
									<h4 style='background-color: transparent; border: none; width: 50%; font-size: 18px; font-weight: bold;'> RIS No. </style> </h4>
									<table class='table table-hover table-bordered table-striped'>
										<thead>
											<th>Item</th>
											<th>Description</th>
											<th>Qty</th>
											<th>Action &nbsp; <label><input type="checkbox" value=""></label></th>
										</thead>
										<tbody>
											<tr>
												<td>Pencil</td>
												<td>Mongol</td>
												<td><input type="number" value="10"> &nbsp;/&nbsp; 10</td>
