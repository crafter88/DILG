	      	...
	      	<aside class="main-sidebar">
	        	<section class="sidebar">
	          		<ul class="sidebar-menu">
	            		<li class="<?php if($nav === 'ris'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>it/ris"><i class="fa fa-pencil"></i> <span>RIS</span></a></li>
	            		<li class="<?php if($nav === 'invoice'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>it/invoice"><i class="fa fa-share"></i> <span>IRP</span></a></li>
	          			<li class="<?php if($nav === 'oejwo'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>it/oejwo"><i class="fa fa-wrench"></i> <span>OEJ/WO</span></a></li>
	          			<li class="<?php if($nav === 'asset'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>it/asset"><i class="fa fa-list-ul"></i> <span>My Assets</span></a></li>
	          			<li class="<?php if($nav === 'accounts'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>it/accounts_departments"><i class="fa fa-users"></i> <span>Accounts / Departments</span></a></li>
	          		</ul>
	       		</section>
	      	</aside>
