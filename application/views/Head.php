	      	...
	      	<aside class="main-sidebar">
	        	<section class="sidebar">
	          		<ul class="sidebar-menu">
	            		<li class="<?php if($nav === 'ppmp'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>head/ppmp"><i class="fa fa-users"></i> <span>PPMP</span></a></li>
	            		<li class="<?php if($nav === 'ris'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>head/ris"><i class="fa fa-pencil"></i> <span>RIS</span></a></li>
	            		<li class="<?php if($nav === 'invoice'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>head/invoice"><i class="fa fa-share"></i> <span>IRP</span></a></li>
	          			<li class="<?php if($nav === 'oejwo'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>head/oejwo"><i class="fa fa-wrench"></i> <span>OEJ/WO</span></a></li>
	          			<li class="<?php if($nav === 'items'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>head/items"><i class="fa fa-archive"></i> <span>Inventory</span></a></li>
	          			<li class="<?php if($nav === 'asset'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>head/asset"><i class="fa fa-list-ul"></i> <span>My Assets</span></a></li>
	          			<li class="<?php if($nav === 'account'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>head/account"><i class="fa fa-user-plus"></i> <span>Accounts</span></a></li>
	          		</ul>
	       		</section>
	      	</aside>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form>
					...
					Office:
					<br><br>
					Home Address: <input type="text" size="35" value=""> 
					<br><br>
					Telephone No: <input type="text" size="35" value=""> 
					<br><br>
					Email:
					<br><br>
					Username: <input type="text" size="35" value="">@dilg-sams.com
					<br><br>
					Password: <input type="password" size="35" value=""> <input type="checkbox">show<br>
					<br><br>
